    ...
    <div class="flex w-full flex-col gap-1.5">
        <div class="flex w-full items-center gap-2">
            <input
                ...
                :class="[
                    checkboxSizeCalc,
                    'cursor-pointer rounded-md border border-neutral-300 text-secondary-500 disabled:pointer-events-none disabled:text-secondary-300 focus:ring-neutral-200 checked:focus:ring-secondary-200 indeterminate:focus:ring-secondary-200 hover:bg-neutral-50 hover:text-secondary-50 checked:hover:bg-secondary-700 indeterminate:hover:bg-secondary-700',
                ]"
                type="checkbox"
                @change="setValue"
            />
...
const props = defineProps<{
    ...
    textFont?: 'bold' | 'semibold' | 'medium' | 'regular'
    textType?:
        | 'h1'
        | 'h2'
        | 'h3'
...
const checkboxSizeCalc = computed(() => {
    if (props.checkboxSize === 's') return 'h-3 w-3'
    if (props.checkboxSize === 'l') return 'h-6 w-6'
    return 'h-5 w-5'
})
